...
public class nicholasskjellum_assignment06 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (cursor.getCount() >0) {
            ...
            do {
                ...
                TableRow tr = new TableRow(nicholasskjellum_assignment06.this);
                ...
                TextView tv = new TextView(nicholasskjellum_assignment06.super.getBaseContext());
                TextView tv1 = new TextView(nicholasskjellum_assignment06.super.getBaseContext());
                TextView tv2 = new TextView(nicholasskjellum_assignment06.super.getBaseContext());
                tv.setText(th.date);
        ...
        btnplus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TableRow row = new TableRow(nicholasskjellum_assignment06.super.getBaseContext());
                TableRow.LayoutParams lp = new TableRow.LayoutParams(TableRow.LayoutParams.WRAP_CONTENT);
               ...
               transaction.date = date;
                ...
                TextView tv3 = new TextView(nicholasskjellum_assignment06.super.getBaseContext());
                tv3.setText(reason);
                row.addView(tv);
                row.addView(tv2);
                row.addView(tv3);
